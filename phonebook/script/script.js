...
const text = (title) => {
    ...
    h6.classList.add('copyright');
    h6.textContent = `Все права защищены © ${title}`;
    return h6;
}
...
const createRow = ({
    ...
    btnEditRow.classList.add('btn-1', 'edt-row');

    tr.append(tdDel, tdName, tdSurname, tdPhone, btnEditRow);
